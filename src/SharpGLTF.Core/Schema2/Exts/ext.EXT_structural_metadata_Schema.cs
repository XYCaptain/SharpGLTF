...
namespace SharpGLTF.Schema2
{
	...
	/// A class property.
	/// </summary>
	partial class StructuralMetaClassProperty : ExtraProperties
	{
		...
		protected override void SerializeProperties(Utf8JsonWriter writer)
		{
			...
			SerializePropertyEnumSymbol<ComponentsType>(writer, "componentType", _componentType);
		...
		protected override void DeserializeProperty(string jsonPropertyName, ref Utf8JsonReader reader)
		{
			switch (jsonPropertyName)
			{
				...
				case "componentType": _componentType = DeserializePropertyValue<ComponentsType>(ref reader); break;
	...
	/// </summary>
	partial class StructuralMetaClass : ExtraProperties
	{
		...
		private Dictionary<String, StructuralMetaClassProperty> _properties;
		...
		protected override void DeserializeProperty(string jsonPropertyName, ref Utf8JsonReader reader)
		{
			switch (jsonPropertyName)
			{
				case "description": _description = DeserializePropertyValue<String>(ref reader); break;
				case "name": _name = DeserializePropertyValue<String>(ref reader); break;
				case "properties": DeserializePropertyDictionary<StructuralMetaClassProperty>(ref reader, _properties); break;
				default: base.DeserializeProperty(jsonPropertyName,ref reader); break;
			}
		}
	...
	/// An enum value.
	/// </summary>
	partial class StructuralMetaEnumValue : ExtraProperties
	{
	...
	/// </summary>
	partial class StructuralMetaEnum : ExtraProperties
	{
		...
		private List<StructuralMetaEnumValue> _values;
		...
		protected override void DeserializeProperty(string jsonPropertyName, ref Utf8JsonReader reader)
		{
			switch (jsonPropertyName)
			{
				...
				case "values": DeserializePropertyList<StructuralMetaEnumValue>(ref reader, _values); break;
				default: base.DeserializeProperty(jsonPropertyName,ref reader); break;
			}
		}
	...
	/// </summary>
	partial class StructuralMetaSchema : ExtraProperties
	{
	
		private Dictionary<String, StructuralMetaClass> _classes;
		
		private String _description;
		
		private Dictionary<String, StructuralMetaEnum> _enums;
		...
		protected override void DeserializeProperty(string jsonPropertyName, ref Utf8JsonReader reader)
		{
			switch (jsonPropertyName)
			{
				case "classes": DeserializePropertyDictionary<StructuralMetaClass>(ref reader, _classes); break;
				case "description": _description = DeserializePropertyValue<String>(ref reader); break;
				case "enums": DeserializePropertyDictionary<StructuralMetaEnum>(ref reader, _enums); break;
