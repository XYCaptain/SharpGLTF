...
namespace SharpGLTF.Schema2
{
	...
	/// </summary>
	partial class FeatureIDTexture : TextureInfo
	{
		private static readonly Int32[] _channelsDefault = {0};
		private const int _channelsMinItems = 1;
		private List<Int32> _channels = _channelsDefault.ToList();
	...
	partial class FeatureID : ExtraProperties
	{
		...
		private FeatureIDTexture _texture;
		...
		protected override void DeserializeProperty(string jsonPropertyName, ref Utf8JsonReader reader)
		{
			switch (jsonPropertyName)
			{
				...
				case "texture": _texture = DeserializePropertyValue<FeatureIDTexture>(ref reader); break;
				default: base.DeserializeProperty(jsonPropertyName,ref reader); break;
			}
		}
	...
	/// </summary>
	partial class FeatureIDs : ExtraProperties
	{
		private const int _featureIdsMinItems = 1;
		protected List<FeatureID> _featureIds;
